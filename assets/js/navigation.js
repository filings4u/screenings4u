(() => {
  ...
  function initNavigation() {
    ...
    nav.innerHTML = `
      ...
      <div class="nav-item mobile-account-nav"><a class="nav-link" href="#account-logins">Account Login <span class="chevron" aria-hidden="true">▼</span></a><div class="dropdown"><a href="https://customers.screenings4u.com/login.html">Customer Login</a><a href="https://portal.screenings4u.com/employer-login.html">Employer Login</a></div></div>
      <div class="mobile-nav-actions"><a class="btn btn-orange" href="services.html">Order a Test</a><a class="btn btn-outline" href="https://customers.screenings4u.com/login.html">Customer Login</a><a class="btn btn-outline" href="https://portal.screenings4u.com/employer-login.html">Employer Login</a></div>`;
